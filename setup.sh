...
APKTOOL_URL="https://github.com/TheBwof/Apkmod/releases/download/v${APKTOOL_VERSION}/apktool-${APKTOOL_VERSION}.apk"

JADX_VERSION="1.3.2"
JADX_URL=https://github.com/skylot/jadx/releases/download/v${JADX_VERSION}/jadx-${JADX_VERSION}.zip

AAPT_URL="https://github.com/TheBwof/Apkmod/releases/download/v${APKTOOL_VERSION}/aapt_@ARCH@.tar.gz"
...
install_deps() {
    ...
    for file in apkmod.p12 signkill.jar hooks/hook2.smali hooks/hook.smali hooks/hook2.dex; do
        wget https://github.com/thebwof/Apkmod/$file -O ~/.apkmod/$file 
    done
}
