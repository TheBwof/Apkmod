...
# Copyright ©2019 by TheBwof. All rights reserved.
#
...
finalwork() {
	[ ! -e ${DESTINATION}/finaltouchup.sh ] && curl --silent -LO https://raw.githubusercontent.com/TheBwof/Apkmod/master/scripts/finaltouchup.sh
	if [ "${MOTD}" = "ON" ]; then
...
printline
printline
printf "\n${blue} [*] Email   :${yellow}    thebwof@gmail.com.com\n"
printf "$blue [*] Website :${yellow}    https://www.fahimahamed.com\n"
printf "$blue [*] YouTube :${yellow}    https://www.youtube.com/@faimahamed_/h\n"
printline
